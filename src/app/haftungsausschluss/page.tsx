...
export default function Haftungsausschluss() {
  return (
    <div id="top" className="max-w-xs md:max-w-xl mx-auto">
      ...
      <section id="Externe">
        ...
        <ol start={1} type="1">
          <li>
            ...
            Link liegenden Inhalte zu Eigen macht. Eine ständige Kontrolle
            dieser externen Links ist für den Anbieter ohne konkrete Hinweise
      ...
      <br />
      <span className="text-small">Stand: 1. Januar 2026</span>
      <br />
    </div>
  );
}
